...
3. Finally, use them to compute the matrix element $$|M|^2=\text{constant}\times \Biggl[\Bigg|\frac{F(1,3)F(2,4)}{\lambda^2+g^2}\Bigg|^2 + \Bigg|\frac{F(1,4)F(2,3)}{\lambda^2+h^2}\Bigg|^2 + \Bigg|\frac{F(1,3)F(2,4)}{\lambda^2+g^2}-\frac{F(1,4)F(2,3)}{\lambda^2+h^2}\Bigg|^2\Biggr]$$
